...
ActiveRecord::Schema.define(version: 20160425212337) do
  ...
  add_index "khachhangs", ["slug"], name: "index_khachhangs_on_slug", unique: true
  ...
  create_table "posts", force: :cascade do |t|
    ...
    t.text     "tongquan"
    t.text     "tieuchuan"
    t.text     "thongtinsanpham"
    t.text     "thongsokythuat"
    t.string   "gia"
    t.string   "slug"
  end
